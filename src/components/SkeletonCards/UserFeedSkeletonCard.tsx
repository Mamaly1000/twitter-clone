...
const UserFeedSkeletonCard = ({ main }: { main?: boolean }) => {
  return (
    <article className="min-w-[300px] max-w-[300px] min-h-[300px] max-h-[300px] rounded-lg drop-shadow-2xl p-0 relative border-[1px] border-neutral-800 cursor-pointer hover:bg-neutral-800 hover:bg-opacity-50">
