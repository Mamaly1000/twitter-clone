...
const Tabs = ({
  ...
  return (
    <section
      className={twMerge(
        "tab-container relative z-0 min-w-full max-w-full overflow-x-auto flex flex-row items-center justify-between  p-0 m-0 [&>button]:first:rounded-bl-md [&>button]:last:rounded-br-md",
        className
      )}
    >
      {options.map((option) => (
