      ...
      >
        {Medias?.map((media) => (
          ...
          >
            ...
            />
            {!!media.description && (
              <p className="min-w-full text-sm capitalize font-bold text-[#d9d9d9] absolute bottom-0 left-0 p-2 bg-light dark:bg-black border-b-[1px] border-neutral-300 dark:border-neutral-800">
                * {media.description}
              </p>
            )}
          </SwiperSlide>
